...
<head>
    <title>5 Marketing Mistakes Small Businesses Should Avoid</title>
    <meta charset="utf-8" />
...
<body>
    ...
    <div class="page-container">
        ...
        <ws-block id="ws-block-footer-kxoi9ptZ" src="../ws/block-templates/footer/index.html" surfaces="ws-light-0">
            <footer class="ws-surface ws-light-0" data-surface="0"
                    ...
                    <ws-footer>
                        ...
                        <ws-global slot="business-social-profiles" src="../ws/globals/social-links/index.html">
                            <ws-social-icons>
                                <ul>
                                    <li>
                                        <a class="ws-link" href="https://www.facebook.com/digipearlaustralia"
                                            target="_blank">
                                            <ws-icon
                                                src="../ws/common/icons/facebook-logo.ws-intense-next-marketing-agency.svg">
                                            </ws-icon>
                                        </a>
                                    </li>
                                    <li>
                                        <a class="ws-link" href="https://www.instagram.com/digipearlaustralia"
                                            target="_blank">
                                            <ws-icon
                                                src="../ws/extensions/11ebb3fc92fa4d148a680026b952c5b1/icons/social-network/solid/yola-instagram-0002.svg">
                                            </ws-icon>
                        ...
                        <ws-global slot="footer-navigation" src="../ws/globals/footer-navigation/index.html">
                            <ul>
                                ...
                                <li>
                                    <a class="ws-link" href="/it-training-programs-with-job-opportunity/"
                                        target="_self">Training
                                        Programs</a>
                                </li>
                            </ul>
                        </ws-global>
                ...
                (function () {
                    ...
                    if (!isRunInEditor()) {
                        ...
                        document.addEventListener('DOMContentLoaded', function () {
                            ...
                            if (wsCookieBannerElement) {
                                wsCookieBannerElement.addEventListener('ws:cookie-banner', function (
                                event) {
                                    if (event.detail && event.detail.accepted) {
                                        if (windowLoaded) {
                                            injectScript();
