...
<head>
  ...
  <link href="../ws/bundles/css/c419d87420c8a2e0cc1a24e000b48d09.css" rel="stylesheet">
</head>
...
<body>
  ...
  <div class="page-container">
    <ws-block id="ws-block-header-c5vgLW1f" src="../ws/block-templates/header/index.html" surfaces="ws-light-0">
    ...
    <ws-block data-ws-variation-id="gallery-specific" id="ws-block-gallery-QAmSpNiW"
      src="../ws/block-templates/gallery/index.html" surfaces="ws-light-1" white-space-bottom="xxl"
      white-space-top="xxl">
      <section class="ws-section ws-surface ws-light-1" data-surface="0"
        ...
        <div class="ws-container">
          <div class="ws-m-block-title-770">
            <ws-text content-untouched="" data-ws-default-content-hash="7eb3823cb888eebb9700ecf7e2825ef6"
              slot="block-title">
              <h6>Superscript</h6>
              <h2>Block title</h2>
              <h5>This is a block description. To edit, click and type the text or replace it with your own custom
                content</h5>
            </ws-text>
          </div>
          <div data-surface="1">
            <ws-columns layout="3-columns" slot="block-columns">
              <ws-column class="col-10 col-sm-8 col-md-6 col-lg-4">
                <ws-media-container aspect-ratio="1.285" content-position="50% 50%" content-scale="1"
                  media-group-id="4t60ot" origin-height="576"
                  origin-src="../ws/blocks/gallery/images/image-3.ws-intense-next-marketing-agency.jpg"
                  origin-width="740">
                  <picture>
                    <source media="(max-width: 576px)"
                      srcset="../ws/alternative-images/w576/blocks/gallery/images/image-3.ws-intense-next-marketing-agency.webp"
                      type="image/webp" />
                    <source media="(max-width: 576px)"
                      srcset="../ws/alternative-images/w576/blocks/gallery/images/image-3.ws-intense-next-marketing-agency.jpg" />
                    <source srcset="../ws/blocks/gallery/images/image-3.ws-intense-next-marketing-agency.webp"
                      type="image/webp" /><img alt="" loading="lazy"
                      src="../ws/blocks/gallery/images/image-3.ws-intense-next-marketing-agency.jpg" />
                  </picture>
                </ws-media-container>
              </ws-column>
              <ws-column class="col-10 col-sm-8 col-md-6 col-lg-4">
                <ws-media-container aspect-ratio="1.285" content-position="50% 50%" content-scale="1"
                  media-group-id="4t60ot" origin-height="576"
                  origin-src="../ws/blocks/gallery/images/image-4.ws-intense-next-marketing-agency.jpg"
                  origin-width="740">
                  <picture>
                    <source media="(max-width: 576px)"
                      srcset="../ws/alternative-images/w576/blocks/gallery/images/image-4.ws-intense-next-marketing-agency.webp"
                      type="image/webp" />
                    <source media="(max-width: 576px)"
                      srcset="../ws/alternative-images/w576/blocks/gallery/images/image-4.ws-intense-next-marketing-agency.jpg" />
                    <source srcset="../ws/blocks/gallery/images/image-4.ws-intense-next-marketing-agency.webp"
                      type="image/webp" /><img alt="" loading="lazy"
                      src="../ws/blocks/gallery/images/image-4.ws-intense-next-marketing-agency.jpg" />
                  </picture>
                </ws-media-container>
              </ws-column>
              <ws-column class="col-10 col-sm-8 col-md-6 col-lg-4">
                <ws-media-container aspect-ratio="1.285" content-position="50% 50%" content-scale="1"
                  media-group-id="4t60ot" origin-height="576"
                  origin-src="../ws/blocks/gallery/images/image-5.ws-intense-next-marketing-agency.jpg"
                  origin-width="740">
                  <picture>
                    <source media="(max-width: 576px)"
                      srcset="../ws/alternative-images/w576/blocks/gallery/images/image-5.ws-intense-next-marketing-agency.webp"
                      type="image/webp" />
                    <source media="(max-width: 576px)"
                      srcset="../ws/alternative-images/w576/blocks/gallery/images/image-5.ws-intense-next-marketing-agency.jpg" />
                    <source srcset="../ws/blocks/gallery/images/image-5.ws-intense-next-marketing-agency.webp"
                      type="image/webp" /><img alt="" loading="lazy"
                      src="../ws/blocks/gallery/images/image-5.ws-intense-next-marketing-agency.jpg" />
                  </picture>
                </ws-media-container>
              </ws-column>
              <ws-column class="col-10 col-sm-8 col-md-6 col-lg-4">
                <ws-media-container aspect-ratio="1.285" content-position="50% 50%" content-scale="1"
                  media-group-id="4t60ot" origin-height="576"
                  origin-src="../ws/blocks/gallery/images/image-6.ws-intense-next-marketing-agency.jpg"
                  origin-width="740">
                  <picture>
                    <source media="(max-width: 576px)"
                      srcset="../ws/alternative-images/w576/blocks/gallery/images/image-6.ws-intense-next-marketing-agency.webp"
                      type="image/webp" />
                    <source media="(max-width: 576px)"
                      srcset="../ws/alternative-images/w576/blocks/gallery/images/image-6.ws-intense-next-marketing-agency.jpg" />
                    <source srcset="../ws/blocks/gallery/images/image-6.ws-intense-next-marketing-agency.webp"
                      type="image/webp" /><img alt="" loading="lazy"
                      src="../ws/blocks/gallery/images/image-6.ws-intense-next-marketing-agency.jpg" />
                  </picture>
                </ws-media-container>
              </ws-column>
              <ws-column class="col-10 col-sm-8 col-md-6 col-lg-4">
                <ws-media-container aspect-ratio="1.285" content-position="50% 50%" content-scale="1"
                  media-group-id="4t60ot" origin-height="576"
                  origin-src="../ws/blocks/gallery/images/image-7.ws-intense-next-marketing-agency.jpg"
                  origin-width="740">
                  <picture>
                    <source media="(max-width: 576px)"
                      srcset="../ws/alternative-images/w576/blocks/gallery/images/image-7.ws-intense-next-marketing-agency.webp"
                      type="image/webp" />
                    <source media="(max-width: 576px)"
                      srcset="../ws/alternative-images/w576/blocks/gallery/images/image-7.ws-intense-next-marketing-agency.jpg" />
                    <source srcset="../ws/blocks/gallery/images/image-7.ws-intense-next-marketing-agency.webp"
                      type="image/webp" /><img alt="" loading="lazy"
                      src="../ws/blocks/gallery/images/image-7.ws-intense-next-marketing-agency.jpg" />
                  </picture>
                </ws-media-container>
              </ws-column>
              <ws-column class="col-10 col-sm-8 col-md-6 col-lg-4">
                <ws-media-container aspect-ratio="1.285" content-position="50% 50%" content-scale="1"
                  media-group-id="4t60ot" origin-height="576"
                  origin-src="../ws/blocks/gallery/images/image-8.ws-intense-next-marketing-agency.jpg"
                  origin-width="740">
                  <picture>
                    <source media="(max-width: 576px)"
                      srcset="../ws/alternative-images/w576/blocks/gallery/images/image-8.ws-intense-next-marketing-agency.webp"
                      type="image/webp" />
                    <source media="(max-width: 576px)"
                      srcset="../ws/alternative-images/w576/blocks/gallery/images/image-8.ws-intense-next-marketing-agency.jpg" />
                    <source srcset="../ws/blocks/gallery/images/image-8.ws-intense-next-marketing-agency.webp"
                      type="image/webp" /><img alt="" loading="lazy"
                      src="../ws/blocks/gallery/images/image-8.ws-intense-next-marketing-agency.jpg" />
                  </picture>
                </ws-media-container>
              </ws-column>
            </ws-columns>
    ...
    <ws-block data-ws-variation-id="cta-with-aside-button-common" id="ws-block-cta-with-aside-button-l0nLptfV"
      src="../ws/block-templates/cta-with-aside-button/index.html" surfaces="ws-dark-1" white-space-bottom="s"
      white-space-top="s">
      <section class="ws-section ws-surface ws-dark-1" data-surface="0"
        data-ws-slots="block-title block-primary-button">
        <div class="ws-container">
          <div class="ws-m-cta-with-aside-button">
            <ws-text content-untouched="" data-ws-default-content-hash="b62f1b8cca2d39829b7987db3759c40e"
              slot="block-title">
              <h3>Show the site visitors what they should do next</h3>
            </ws-text>
    ...
    <ws-block id="ws-block-footer-eAr6ZlOc" src="../ws/block-templates/footer/index.html" surfaces="ws-light-1">
