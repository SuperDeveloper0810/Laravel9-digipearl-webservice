...
<head>
  <meta
    content="Web Design, Ecommerce Web Design, Search Engine Optimisation , SEO, Mobile APP Development, Social Media Management, Logo, Banner, Branding, Training, Business Ready Program, Job Ready Program"
    name="keywords" />
  <meta
    content="We Are The #1 Digital Service Providing Firm In Sydney. Any Website Design &amp; Development From $500. We Can Make You Online In 2-3 Weeks."
    name="description" />
  <title>Digital Services | DigiPearl</title>
  <meta charset="utf-8" />
  ...
  <link href="../ws/bundles/css/8862046dd667db5fc6a5f5b305f0e97b.css" rel="stylesheet">
</head>
...
<body>
  ...
  <div class="page-container">
    <ws-block id="ws-block-header-fXMdFQra" src="../ws/block-templates/header/index.html" surfaces="ws-light-0">
    ...
    <ws-block data-ws-variation-id="media-fullwidth-common" id="ws-block-media-fullwidth-SW5gtkjp"
      ...
      <section class="ws-block-media ws-surface ws-light-0" data-surface="0" data-ws-slots="block-media">
        <ws-media-container aspect-ratio="3.077" content-position="50% 50%" content-scale="1" media-group-id="awciMa"
          slot="block-media">
          <picture>
    ...
    <ws-block content-alignment="left" data-ws-id="ref_59" data-ws-variation-id="services-with-media-common-3cols"
      id="ws-block-services-with-media-kr7tB7Ut" src="../ws/block-templates/services-with-media/index.html"
      surfaces="ws-light-0" white-space-bottom="xxl" white-space-top="xxl">
      <section class="ws-section ws-surface ws-light-0" data-surface="0"
        ...
        <div class="ws-container">
          <div class="ws-m-block-title-770">
            <ws-text data-alignment="center" data-ws-default-content-hash="7eb3823cb888eebb9700ecf7e2825ef6"
              slot="block-title">
              <h2>Our Services</h2>
            </ws-text>
          </div>
          <div class="ws-m-service" data-surface="1">
            <ws-columns layout="3-columns" slot="block-columns">
              <ws-column class="col-10 col-sm-8 col-md-6 col-lg-4">
                <article>
                  <ws-media-container aspect-ratio="1.542" content-position="50% -13.54%" content-scale="1.54"
                    media-group-id="al3vC7">
                    <picture>
                      <source
                        srcset="../ws/blocks/services-with-media/images/image-1.ws-intense-next-marketing-agency.webp"
                        type="image/webp" /><img alt="" loading="lazy"
                        src="../ws/blocks/services-with-media/images/image-1.ws-intense-next-marketing-agency.jpg" />
                    </picture>
                  </ws-media-container>
                  <ws-text data-ws-default-content-hash="a60568d1ebef5f99ec64ac4470a24eeb">
                    <h4><a data-ws-selectable="true" href="/web-design/" target="_self">Web Design</a></h4>
                    <p>At<b> DigiPearl – A digital agency in Sydney</b>, we are well-known for our exceptional drive and
                      creativity. Our Sydney web designers create custom web sites that not only stand out from the
                      competition, but actively promote and enhance your brand.</p>
                  </ws-text>
                </article>
              </ws-column>
              <ws-column class="col-10 col-sm-8 col-md-6 col-lg-4">
                <article>
                  <ws-media-container aspect-ratio="1.542" content-position="50% 51.39%" content-scale="1"
                    media-group-id="al3vC7">
                    <picture>
                      <img alt="" loading="lazy"
                        src="../ws/media-library/447f6d0b95324fd8b77ad5a97c990bed/hglc8l-eccm" />
                    </picture>
                  </ws-media-container>
                  <ws-text data-ws-default-content-hash="26833ae6dd25a4bb36c5513973a8794e">
                    <h4><a data-ws-selectable="true" href="/web-design/" target="_self">Ecommerce Web Design</a></h4>
                    <p>Do you want to sell products online? At DigiPearl in Sydney, we create beautiful ecommerce stores
                      that engage and excite shoppers. Your e-commerce store is custom designed, mobile friendly
                      responsive and tailored specifically to suit your business needs.</p>
                  </ws-text>
                </article>
              </ws-column>
              <ws-column class="col-10 col-sm-8 col-md-6 col-lg-4">
                <article>
                  <ws-media-container aspect-ratio="1.542" content-position="50% 50%" content-scale="1"
                    media-group-id="al3vC7">
                    <picture>
                      <img alt="" loading="lazy"
                        src="../ws/media-library/8adee3c4a4164214a26e23bd7249fa97/x60yftdosgu" />
                    </picture>
                  </ws-media-container>
                  <ws-text data-ws-default-content-hash="9f6423070a6c97e97fb807678ec99bf1">
                    <h4><a data-ws-selectable="true" href="/telecom-services/" target="_self">Branding (Logo-Banner)</a>
                    </h4>
                    <p>Our team of award-winning designers will prove how good quality design doesn’t need to be
                      expensive. We assure you of our commitment to provide you with the best service, keeping you in
                      the loop throughout the entire process, from the beginning until the end of the project.</p>
                  </ws-text>
                </article>
              </ws-column>
              <ws-column class="col-10 col-sm-8 col-md-6 col-lg-4">
                <article>
                  <ws-media-container aspect-ratio="1.542" content-position="53.14% 50%" content-scale="1"
                    media-group-id="al3vC7">
                    <picture>
                      <img alt="" loading="lazy"
                        src="../ws/media-library/3eca2f9186dd4636b9fa7666f8f8dc30/shr_xn8s8qu" />
                    </picture>
                  </ws-media-container>
                  <ws-text data-ws-default-content-hash="9f6423070a6c97e97fb807678ec99bf1">
                    <h4><a data-ws-selectable="true" href="/digital-marketing/" target="_self">SEO (Search engine
                        optimisation)</a></h4>
                    <ul>
                      <li>
                        <p>Organically rank higher on Google searches</p>
                      </li>
                      <li>
                        <p>Competitor analysis and keyword research</p>
                      </li>
                      <li>
                        <p>Direct relevant traffic to your website</p>
                      </li>
                      <li>
                        <p>Monthly benchmark and progress reports</p>
                      </li>
                    </ul>
                  </ws-text>
                </article>
              ...
              <ws-column class="col-10 col-sm-8 col-md-6 col-lg-4">
                <article>
                  <ws-media-container aspect-ratio="1.542" content-position="50% 50%" content-scale="1"
                    ...
                    <picture>
                      <img alt="" loading="lazy"
                        src="../ws/media-library/9dfa22e461e24e82966f9879aaa3b724/w33-zg-dnl4" />
                    </picture>
                  </ws-media-container>
                  <ws-text data-ws-default-content-hash="9f6423070a6c97e97fb807678ec99bf1">
                    <h4><b><a href="#" target="_self">Mobile App Development</a></b></h4>
                    <h6>With amazingly low prices, all businesses can now enjoy having their own App! Our mobile
                      Apps are no longer just for big businesses, and have the same functionality and high quality, at a
                      much lower cost. We can help to create a personalised experience for you and your customers.</h6>
                  </ws-text>
                </article>
              </ws-column>
              <ws-column class="col-10 col-sm-8 col-md-6 col-lg-4">
                <article>
                  <ws-media-container aspect-ratio="1.542" content-position="50% 50%" content-scale="1"
                    ...
                    <picture>
                      <img alt="" loading="lazy"
                        src="../ws/media-library/d8bd7c32a4964e1ea3503a195b49b618/6lct2krpvni" />
                    </picture>
                  </ws-media-container>
                  <ws-text data-ws-default-content-hash="9f6423070a6c97e97fb807678ec99bf1">
                    <h4><a href="#" target="_self">Social Media Management</a></h4>
                    <ul>
                      <li>
                        <h6>Facebook Management</h6>
                      </li>
                      <li>
                        <h6>Instagram Management</h6>
                      </li>
                      <li>
                        <h6>Linkedin Management</h6>
                      </li>
                      <li>
                        <h6>Google Business Management</h6>
                      </li>
                    </ul>
                    <h6>You focus on Business, we will take care of the Social presence</h6>
                    <p><br /></p>
                    <p><br /></p>
                  </ws-text>
                </article>
    ...
    <ws-block id="ws-block-footer-GiCPBjAH" src="../ws/block-templates/footer/index.html" surfaces="ws-light-1">
      <footer class="ws-surface ws-light-1" data-surface="0" data-ws-hidden-children="business_description site_name"
  ...
  <script src="../ws/bundles/js/3498e4114a8f8c62b5369db5dbf5c43a.js"></script>
