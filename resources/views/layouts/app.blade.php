...
<head>
    <meta
        content="ICT solution, Website design, Mobile Apps, SEO, Business Setup, Job-ready Training, Social Media Management, Branding, Logo-Banner, Ecommerce Web Design"
        name="keywords" />
    <meta
        content="Professional Digital Marketing In Sydney. Fixed Price Digital Services. Website Design &amp; SEO. Ecommerce And Social Media Promotion. Branding Your Business."
        name="description" />
    <title>ICT Company | DigiPearl Sydney</title>
    <meta name="ws:template:build_name" value="Selma" />
    <meta name="ws:template:build_id" value="ws-intense-next-marketing-agency" />
    <meta charset="utf-8" />
    ...
    <!--/ws:site:tracking_code-->
    <link as="image"
        href="ws/alternative-images/w1152/blocks/cover-with-plain-text/images/image-2.ws-intense-next-marketing-agency.webp"
        media="(max-width: 576px)" rel="preload" />
    <script>
        (function (context) {
    ...
    <meta content="R_0GT6i8Rgj_kXo5wPyzwLrwmaGtWgMS8hvb8mI63YM" name="google-site-verification" />
    @yield('styles')
...
<body>
                    ...
                    WebFontConfig = {
                        ...
                        function (e) {
                            var a = e.createElement('script'),
                                s = e.head;
                            a.src = 'https://ajax.googleapis.com/ajax/libs/webfont/1.6.26/webfont.js', a.async = !0, s
                                .appendChild(a,
                                    s)
                        }(document);
    ...
    <div class="page-container">
        <ws-block id="ws-block-header-O105bvUK" src="ws/block-templates/header/index.html" surfaces="ws-light-0">
                                ...
                                <nav>
                                    <ul class="ws-nav__menu-list">
                                            ...
                                            <ws-nav-collapse class="ws-nav__submenu" id="ws-nav-collapse-2">
                                                <ul class="ws-nav__submenu-list">
                                                    ...
                                                    @foreach ($services as $service)
                                                        <li class="ws-nav__submenu-list-item">
                                                            <a class="ws-nav__menu-link" href="{{$service->link}}">
                                        ...
                                        @foreach ($menus as $menu)
                                            <li class="ws-nav__menu-list-item">
                                                <a class="ws-nav__menu-link" href="{{$menu->link}}" target="_self">
                                                    <span>{{$menu->name}}</span>
                                                </a>
                                            </li>
                                        @endforeach
                                        <li class="ws-nav__menu-list-item">
                                            <a class="ws-nav__menu-link" href="/admin/login" target="_self">
                                                <span>Admin</span>
                                            </a>
                                        </li>
                                    </ul>
        ...
        <ws-block id="ws-block-footer-oVqIJBPd" src="ws/block-templates/footer/index.html" surfaces="ws-light-1">
            <footer class="ws-surface ws-light-1" data-surface="0"
                data-ws-hidden-children="business_description site_name" data-ws-slots="footer">
                <ws-global slot="footer" src="ws/globals/global-footer/index.html">
                    <ws-footer>
                        ...
                        @foreach ($contactInfos as $contactInfo)
                            <ws-global slot="business-email" src="ws/globals/emails/index.html">
                                <p>{{ $contactInfo->type }} <a href="mailto: info@digipearl.com.au" target="_self">{{ $contactInfo->info }}</a>
                                </p>
                            </ws-global>
                        @endforeach
                        ...
                        <ws-global slot="footer-navigation" src="ws/globals/footer-navigation/index.html">
                            <ul>
                                ...
                                @foreach ($menus as $menu)
                                    <li>
                                        <a class="ws-link" href="{{$menu->link}}" target="_self">{{$menu->name}}</a>
                                    </li>
                                @endforeach
                            </ul>
                        </ws-global>
